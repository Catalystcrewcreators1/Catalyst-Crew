        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <ScrollReveal>
              ...
              >
                <Code className="w-5 h-5 text-red-400 mr-3" />
                <span className="text-sm font-semibold text-red-400">Web Development</span>
              </motion.div>
            </ScrollReveal>
      ...
      <section className="py-24 relative bg-red-900/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <div className="text-6xl font-bold text-red-400 mb-4">4-8 weeks</div>
