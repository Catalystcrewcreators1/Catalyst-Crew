          ...
          <div className="text-center">
            <ScrollReveal>
              ...
              >
                ...
                <span className="text-sm font-semibold text-red-400">Brand Identity</span>
              </motion.div>
            </ScrollReveal>
      ...
      <section className="py-24 relative bg-red-900/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <div className="text-6xl font-bold text-red-400 mb-4">3-4 weeks</div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-heading font-bold mb-6">
                <span className="block mb-2" style={{ color: '#D71B1B' }}>Brand</span>
                <span className="text-white">Packages</span>
              </h2>
