...
const GraphicDesign = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Eye-catching designs for promotional materials"
    },
    {
      icon: <Layout className="w-8 h-8" />,
      title: "Poster & Banner Design",
      description: "Large format designs for events and advertising"
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Digital Asset Design",
      description: "Modern digital graphics for web and social media"
    }
  ];
  ...
  const packages = [
    ...
    {
      category: "Posters",
      title: "Professional posters solutions",
      items: [
        {
          name: "Basic",
          price: "₹499",
          description: "1 Design, 3 Revisions, High Resolution, Print Ready",
          features: [
            "1 Design",
            "3 Revisions",
            "High Resolution",
        ...
        },
        {
          name: "Medium",
          price: "₹499",
          description: "1 Design, 3 Revisions, High Resolution, Print Ready, QR Code Integration",
          features: [
            "1 Design",
            "3 Revisions",
            "High Resolution",
        ...
        },
        {
          name: "Premium",
          price: "₹549",
          description: "1 Design, 5 Revisions, High Resolution, Print Ready, QR Code Integration, Social Media Kit",
          features: [
            "1 Design",
            "5 Revisions",
            "High Resolution",
    ...
    {
      category: "Banners",
      title: "Professional banners solutions",
      items: [
        {
          name: "Basic",
          price: "₹449",
          description: "1 Design, 2 Revisions, Multiple Sizes",
          features: [
            "1 Design",
            "2 Revisions",
            "Multiple Sizes"
        ...
        },
        {
          name: "Medium",
          price: "₹499",
          description: "1 Design, 3 Revisions, Multiple Sizes, Source Files",
          features: [
            "1 Design",
            "3 Revisions",
            "Multiple Sizes",
        ...
        },
        {
          name: "Premium",
          price: "₹549",
          description: "1 Design, 5 Revisions, Multiple Sizes, Source Files, Mockup Presentation",
          features: [
            "1 Design",
            "5 Revisions",
            "Multiple Sizes",
    ...
    {
      category: "Business & Visiting Cards",
      title: "Professional business & visiting cards solutions",
      items: [
        {
          name: "Basic",
          price: "₹149",
          description: "100 Cards, Standard Paper, 1 Design",
          features: [
            "100 Cards",
            "Standard Paper",
            "1 Design"
        ...
        },
        {
          name: "Medium",
          price: "₹199",
          description: "200 Cards, Premium Paper, 1 Design, Free Delivery",
          features: [
            "200 Cards",
            "Premium Paper",
            "1 Design",
        ...
        },
        {
          name: "Premium",
          price: "₹249",
          description: "300 Cards, Luxury Paper, 2 Designs, Free Delivery, Box Packaging",
          features: [
            "300 Cards",
            "Luxury Paper",
            "2 Designs",
    ...
    // Menu & Food Posters
    {
      category: "Menu & Food Posters",
      title: "Professional menu & food posters solutions",
      items: [
        {
          name: "Basic",
          price: "₹599",
        ...
        },
        {
          name: "Medium",
          price: "₹649",
          description: "1 Design, 3 Revisions, High Resolution, Print Ready, Custom Layout",
          features: [
            "1 Design",
            "3 Revisions",
            "High Resolution",
        ...
        },
        {
          name: "Premium",
          price: "₹699",
          description: "1 Design, 5 Revisions, High Resolution, Print Ready, Custom Layout, Multiple Sizes",
          features: [
            "1 Design",
            "5 Revisions",
            "High Resolution",
    ...
    // CV / Resume Designs
    {
      category: "CV / Resume Designs",
      title: "Professional cv / resume designs solutions",
      items: [
        {
          name: "Basic",
          price: "₹249",
          description: "1 Design, 2 Revisions, PDF Format",
          features: [
            "1 Design",
            "2 Revisions",
            "PDF Format"
        ...
        },
        {
          name: "Medium",
          price: "₹299",
          description: "1 Design, 3 Revisions, PDF Format, Multiple Templates",
          features: [
            "1 Design",
            "3 Revisions",
            "PDF Format",
        ...
        },
        {
          name: "Premium",
          price: "₹349",
          description: "1 Design, 5 Revisions, PDF Format, Multiple Templates, Cover Letter",
          features: [
            "1 Design",
            "5 Revisions",
            "PDF Format",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <ScrollReveal>
              ...
              >
                <Palette className="w-5 h-5 text-red-400 mr-3" />
                <span className="text-sm font-semibold text-red-400">Graphic Design</span>
              </motion.div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              ...
              >
                <p className="text-xl md:text-2xl text-white/80 leading-relaxed">
                  Comprehensive graphic design services for all your visual needs, from marketing
                  materials to digital assets.
                </p>
              </motion.div>
            </ScrollReveal>
      ...
      <section className="py-24 relative bg-red-900/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <div className="text-6xl font-bold text-red-400 mb-4">2-3 weeks</div>
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-white/70 max-w-3xl mx-auto">
                Professional graphic design services with competitive pricing. Get a personalized quote for your project.
              </p>
            </div>
          </ScrollReveal>
            ...
            {[
              {
                ...
                content: "The graphic design team created stunning marketing materials that perfectly captured our brand. Outstanding work!",
                rating: 5
              },
              {
                name: "Michael Chen",
                company: "Growth Co.",
                content: "Professional designs that exceeded our expectations. The team was creative and delivered on time.",
                rating: 5
              },
              {
                name: "Emily Rodriguez",
                company: "Creative Solutions",
                content: "Amazing graphic design service! They understood our vision and created visually appealing materials.",
                rating: 5
              }
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-xl text-white/70 mb-12 max-w-2xl mx-auto">
              Get a personalized quote for your graphic design project. Let's create something amazing together.
            </p>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/contact"
